  ...
  return (
    <section className={styles.hero}>
      ...
      <p data-aos="fade-up" data-aos-delay="200">
        divtech studio hadir untuk UMKM, bisnis, dan instansi yang ingin tampil
        profesional di internet — dari landing page sederhana hingga sistem
        berbasis web yang kompleks.
      </p>
